...
void GT_InitGametype()
{
    ...
    G_ConfigString( CS_SCB_PLAYERTAB_LAYOUT, "%a l1 %n 112 %s 52 %s 32 %t 80 %s 36 %s 48 %l 40 %s 48" );
    G_ConfigString( CS_SCB_PLAYERTAB_TITLES, "AVATAR Name Clan Pos Time Diff Speed Ping Racing" );
